...
import auth from '../middlewares/middleware_auth';
...
*/
productRouter.get("/api/products/get/:category", async (req, res)=>{
...
productRouter.get("/api/products/get/highest-rated", async (req, res) => {
